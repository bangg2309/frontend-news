    ...
    return (
        <div className="horizontal-box-wrapper sticky top-16 pb-4">
                    ...
                    <div key={index} className="grid grid-cols-2 mb-5 max-w-xs">
                        ...
                        <div className="leading-5">
                            <h3 className="vnn-title">
                                <a className={"text-[#2a2a2a] font-sans text-[15px] leading-[19px]"}
            ...
            <div className="text-center mt-6">
                <a href="/" className="bg-transparent border-[1px] border-[#2d67ad] rounded-[50px] text-[#2d67ad] cursor-pointer font-sans font-bold text-[12px] px-[15px] py-[5px]" title="Quay lại trang chủ">
                    <img className="mr-2 mb-0.5 inline-block" src="https://static.vnncdn.net/v1/icon/icon-pre-bule-sm.png"/>
                    QUAY LẠI TRANG CHỦ
                </a>
            </div>
        </div>
